	...
	public function create()
        {
            ...
            $this->form_validation->set_rules('nama_penyakit', 'Username', 'trim|required|callback_alpha_dash_space');
            $this->form_validation->set_rules('tgl_sakit', 'Tanggal Sakit', 'trim|required|alpha_dash');
            $this->form_validation->set_rules('tgl_sembuh', 'Tanggal Sembuh', 'trim|alpha_dash');
         
            /*if (empty($_FILES['foto']['name'])){
                $this->form_validation->set_rules('foto', 'Profile Picture', 'required');
            }*/
